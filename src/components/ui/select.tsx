...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // "flex h-10 w-full items-center justify-between rounded-md border border-slate-600 bg-white px-3 py-2 text-sm placeholder:text-slate-600 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-slate-600  dark:bg-slate-600 dark:ring-offset-slate-600 dark:placeholder:text-slate-400 dark:focus:ring-slate-300",
      "flex h-10 w-full items-center justify-between px-3 py-2 placeholder:text-slate-600 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:bg-white/0 dark:hover:bg-white/5",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown viewBox="0 0 24 24" className="h-4 w-4 opacity-50" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp viewBox="0 0 24 24" className="h-4 w-4" />
  </SelectPrimitive.ScrollUpButton>
))
